...
object Categories {
    ...
    const val imagesPath: String =
            "/Users/gratchuvalsky/Documents/RestaurantInformationSystem/src/main/resources/images/"
...
object BreakfastCategoryItems: MenuItems {
    ...
    const val SALMON_TOAST_IMG = Categories.imagesPath + "SalmonToast.jpg"

    const val GLAZUNIA_S_SOSISKAMI_NAME = "Яичница глазунья с сосисками"
    const val GLAZUNIA_S_SOSISKAMI_IMG = Categories.imagesPath + "Glazunia_s_sosiskami.jpg"

    const val OVSYANKA_NAME = "Каша овсяная с маслом"
    const val OVSYANKA_IMG = Categories.imagesPath + "Ovsyanka.jpg"

    const val SYRNYKY_NAME = "Два сырника с сахарной пудрой"
    const val SYRNYKY_IMG = Categories.imagesPath + "Syrnyky.jpg"
...
object SaladsCategoryItems: MenuItems {
    ...
    const val SALAD_WITH_SHRIMPS_IMG = Categories.imagesPath + "Salad with shrimps.jpg"

    const val SALAD_WITH_TURKEY_NAME = "Салат с индейкой"
    const val SALAD_WITH_TURKEY_IMG = Categories.imagesPath + "Salad with turkey.jpg"

    const val CHUKKA_NAME = "Чукка салат"
    const val CHUKKA_IMG = Categories.imagesPath + "Chukka.jpg"

    const val JAPANESE_SALAD_WITH_CHIKEN_NAME = "Японский салат с курицей"
    const val JAPANESE_SALAD_WITH_CHIKEN_IMG = Categories.imagesPath + "Japanese salad with chiken.jpg"

    const val CAESAR_SALAD_WITH_CHIKEN_NAME = "Салат цезарь с курицей"
    const val CAESAR_SALAD_WITH_CHIKEN_IMG = Categories.imagesPath + "Caesar salad with chiken.jpg"
...
object AppetizerCategoryItems: MenuItems {
    ...
    const val KREVETKI_V_TEMPURE_IMG = Categories.imagesPath + "krevetki v tempure.jpg"

    const val GRENKI_NAME = "Гренки с сыром и чесноком"
    const val GRENKI_IMG = Categories.imagesPath + "Grenki.jpg"

    const val KESADILIA_WITH_CHIKEN_NAME = "Кесадилья с курицей"
    const val KESADILIA_WITH_CHIKEN_IMG = Categories.imagesPath + "kesadilia with chiken.jpg"

    const val KREVETKI_PO_SYNGAPURSKY_NAME = "Креветки по-сингапурски"
    const val KREVETKI_PO_SYNGAPURSKY_IMG = Categories.imagesPath + "krevetki po singapursky.jpg"
...
object SoupCategoryItems: MenuItems {
    ...
    const val TOM_YAM_WITH_CHIKEN_IMG = Categories.imagesPath + "tom yam with chiken.jpg"

    const val MUSHROOM_CREAM_SOUP_NAME = "Грибной крем-суп"
    const val MUSHROOM_CREAM_SOUP_IMG = Categories.imagesPath + "mushroom cream soup.jpg"

    const val UDON_NAME = "Удон"
    const val UDON_IMG = Categories.imagesPath + "udon.jpg"

    const val BORSH_S_GOVYADINOY_NAME = "Борщ с говядиной"
    const val BORSH_S_GOVYADINOY_IMG = Categories.imagesPath + "borsh s govyadinoy.jpg"
